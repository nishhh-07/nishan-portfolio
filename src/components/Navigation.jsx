...
const Navigation = ({ isDark, toggleTheme }) => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (isOpen && !event.target.closest('.navbar')) setIsOpen(false);
    };
          ...
          <div className="nav-links desktop-nav">
            ...
            <div className="nav-social">
              {personalInfo.social.github && (
                <a href={personalInfo.social.github} className="nav-social-link"
              ...
              {personalInfo.social.linkedin && (
                <a href={personalInfo.social.linkedin} className="nav-social-link"
