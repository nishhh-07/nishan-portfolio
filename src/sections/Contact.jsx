    ...
    <section id="contact" className="contact-section">
      <div className="container">
        ...
        <p className="contact-intro">
          I'm currently looking for opportunities where I can contribute to building reliable, scalable and user-focused software.
        </p>
          ...
          <div className="contact-cta">
            <div className="cta-card glass-card">
              ...
              <p className="cta-description">
                Feel free to reach out to discuss opportunities, projects, or just to connect.
              </p>
